...
class TestMonologicScoring:
    def test_purely_declarative_is_monologic(self):
        from agents.hapax_daimonion.grounding_evaluator import _score_monologic
...
class TestDirectiveCompliance:
    def test_advance_always_compliant(self):
        from agents.hapax_daimonion.grounding_evaluator import score_directive_compliance
