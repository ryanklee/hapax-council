...
> **Sister extension:** kept byte-near-identical with `hapax-officium/vscode/CLAUDE.md`. The only intentional difference is the logos API port (8051 here, 8050 there). Any other drift is a bug — edit both in sync.
