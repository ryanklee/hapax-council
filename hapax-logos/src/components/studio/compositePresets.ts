...
export const PRESETS: CompositePreset[] = [
  ...
  },
  {
    ...
    overlay: {
      delayFrames: 10,
      filter: "saturate(0.4) sepia(0.6) hue-rotate(280deg) brightness(1.2)",
      alpha: 0.45,
      blendMode: "lighter",
      driftY: 8,
    },
  ...
  },
  {
    ...
    colorFilter:
      "saturate(0.4) sepia(0.55) hue-rotate(-10deg) contrast(1.25) brightness(1.1)",
    trail: {
      filter: "saturate(0.3) sepia(0.6) brightness(1.05)",
      blendMode: "lighter",
      opacity: 0.25,
      count: 3,
      driftX: 0,
  ...
  },
  {
    ...
    colorFilter: "saturate(3.5) contrast(1.8) brightness(1.1)",
    trail: {
      filter: "saturate(4) contrast(1.3) brightness(1.6)",
      blendMode: "lighter",
      opacity: 0.6,
      count: 8,
      driftX: 0,
    ...
    bloom: { enabled: true, threshold: 0.6, radius: 12, alpha: 0.7 },
