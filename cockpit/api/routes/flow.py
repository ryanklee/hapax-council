...
def get_flow_state() -> dict:
    ...
    # Edges
    edges = [
        {"source": "perception", "target": "stimmung", "active": perc_age < 10, "label": "perception confidence"},
        {"source": "perception", "target": "temporal", "active": perc_age < 10, "label": "perception ring"},
        {"source": "perception", "target": "consent", "active": perc_age < 10, "label": "faces + speaker"},
        {"source": "stimmung", "target": "apperception", "active": stim_age < 120, "label": "stance"},
        {"source": "temporal", "target": "apperception", "active": temp_age < 10, "label": "surprise"},
        {"source": "temporal", "target": "phenomenal", "active": temp_age < 30, "label": "bands"},
        {"source": "apperception", "target": "phenomenal", "active": apper_age < 30, "label": "self-band"},
        {"source": "stimmung", "target": "phenomenal", "active": stim_age < 120, "label": "attunement"},
        ...
        {"source": "stimmung", "target": "compositor", "active": stim_age < 120, "label": "visual mood"},
        {"source": "perception", "target": "compositor", "active": perc_age < 10, "label": "signals"},
        {"source": "engine", "target": "compositor", "active": True, "label": "engine state"},
        {"source": "stimmung", "target": "engine", "active": stim_age < 120, "label": "phase gating"},
        {"source": "consent", "target": "voice", "active": consent_phase != "none", "label": "consent gate"},
    ]
