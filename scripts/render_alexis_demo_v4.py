...
SCENES: list[tuple[str, str]] = [
    ...
    ("00-intro",
     "This is a system called Hapax. It started as a tool for executive function support and became a research project."
    ),
    ...
    ("17-transition",
     ...
     "The research is different. It is not finished. It is not proven. "
    ...
    ("19-gap",
     ...
     "Then in 2024, researchers found that reinforcement learning from human feedback, "
     ...
     "A separate study tested frontier models on a grounding benchmark. "
    ...
    ("20-voice-architecture",
     ...
     "The grounding loop classifies every response. Accept, clarify, reject, or ignore. "
     "Based on that classification, the system decides what to do next. "
    ...
    ("22-methodology",
     ...
     "A known problem with this design for grounding: "
