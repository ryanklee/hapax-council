...
SCENES: list[tuple[str, str]] = [
    ...
    ("12-research-intro",
     ...
     "Now the research. This part is not finished. It is not proven. "
    ...
    ("13-clark",
     ...
     "No voice assistant has ever used it."
    ),

    ("14-why-not",
     "Thirty-five years between that research and any attempt to build it. "
     "Then in 2024, researchers found that the training used to make language models conversational "
     ...
     "Tested on a grounding benchmark, every model scored below random chance. "
    ...
    ("15-voice-system",
     ...
     "If something matters more, it requires stronger evidence of understanding. "
    ...
    ("16-methodology",
     ...
     "It has been replaced with one that measures meaning similarity, not word matching. "
     "Expected effects are modest. The probability of strong evidence is forty to fifty percent. "
