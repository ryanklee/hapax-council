...
from logos.data.briefing import BriefingData, collect_briefing
...
def _collect_knowledge_sufficiency_nudges(nudges: list[Nudge]) -> None:
    ...
    try:
        from logos.data.knowledge_sufficiency import collect_all_domain_gaps, gaps_to_nudges
...
def _filter_dismissed(nudges: list[Nudge]) -> list[Nudge]:
    ...
    try:
        from logos.data.decisions import collect_decisions
