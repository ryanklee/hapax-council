...
from logos._affordance import ActivationState, CapabilityRecord, SelectionCandidate
from logos._affordance_metrics import AffordanceMetrics
from logos._impingement import Impingement, render_impingement_text
...
class AffordancePipeline:
    ...
    def index_capability(self, record: CapabilityRecord) -> bool:
        from logos._config import embed_safe, get_qdrant
