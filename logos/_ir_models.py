"""Vendored IR detection models for the logos package.

Copied from shared/ir_models.py. Pydantic models for Pi NoIR edge
detection reports. Shared between Pi edge daemon (producer) and
council API (consumer).
"""
