"""Vendored config constants for the logos package.

Subset of shared/config.py — only the symbols used by logos/ modules.
"""
...
VAULT_PATH: Path = WORK_VAULT_PATH  # backwards compat alias
HAPAX_CONSTITUTION_DIR: Path = HAPAX_PROJECTS_DIR / "hapax-constitution"
HAPAXROMANA_DIR: Path = HAPAX_CONSTITUTION_DIR  # legacy alias
...
_log = logging.getLogger("logos._config")
