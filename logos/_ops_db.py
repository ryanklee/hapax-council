"""Vendored ops database for the agents package.

Copied from shared/ops_db.py. Build in-memory SQLite from operational
JSONL/JSON files. Reusable by query agents, voice tools, logos collectors,
or any consumer needing SQL access to operational history data.
"""
...
log = logging.getLogger("agents.ops_db")
