"""agents/_dimensions.py — Vendored profile dimension registry.

Copied from shared/dimensions.py to dissolve the shared module dependency.
"""
...
DIMENSIONS: tuple[DimensionDef, ...] = (
    ...
    DimensionDef(
        ...
        primary_sources=("audio_processor", "screen_context", "interview", "ir_presence"),
    ),
    DimensionDef(
        name="tool_usage",
        kind="behavioral",
...
def get_dimension_names() -> list[str]:
    """Return all dimension names as a list."""
