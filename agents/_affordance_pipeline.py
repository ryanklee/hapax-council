...
from agents._affordance import ActivationState, CapabilityRecord, SelectionCandidate
from agents._affordance_metrics import AffordanceMetrics
from agents._impingement import Impingement, render_impingement_text
