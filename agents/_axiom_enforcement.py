"""Vendored axiom enforcement for the agents package.

Copied from shared/axiom_enforcement.py. Framework-agnostic axiom enforcement
with hot/cold split.
...
Neither depends on pydantic-ai.
"""
