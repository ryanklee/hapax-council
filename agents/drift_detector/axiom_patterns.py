"""Vendored from shared/axiom_patterns.py — T0 violation pattern scanning."""
...
# Pattern data file lives alongside the shared module
_PATTERNS_FILE = Path(__file__).resolve().parent.parent.parent / "shared" / "axiom_patterns.txt"
